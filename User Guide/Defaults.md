**Defaults** appear in the **Detail Editor** of [Skills](Skills.md) and [Equipment](Equipment.md) items that define weapon usage (see [Melee and Ranged Weapons](Melee%20and%20Ranged%20Weapons.md)).
